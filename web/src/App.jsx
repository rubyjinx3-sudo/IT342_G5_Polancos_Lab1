    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          {/* ✅ /dashboard/events and /dashboard/my-events both show DashboardPage */}
          ...
          <Route path="/dashboard/my-events" element={
            <ProtectedRoute requiredRole="student">
              <WithNav><DashboardPage /></WithNav>
            </ProtectedRoute>
          } />

          {/* ✅ Fixed: param name matches useParams() in EventDetailPage */}
